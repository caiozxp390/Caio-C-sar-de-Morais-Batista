...
int main() {
    const int TAMANHO = 10000; // Tamanho dos vetores para teste
    ...
    // Preenchendo vetor quase ordenado
...
void selectionSort(vector<int>& vetor) {
    ...
    for(int i = 0; i < tamanho-1; i++) { // Percorre todo o vetor
        ...
        for(int j = i+1; j < tamanho; j++) { // Percorre o restante do vetor
